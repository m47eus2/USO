...
ret = solve_ivp(model, [0,10], [np.pi/4,0,0,0], rtol=1e-10, atol=1e-10)
...
ret = solve_ivp(model2, [0,10], [np.pi/4,0,0,0], rtol=1e-10, atol=1e-10)


plt.plot(ret.t, ret.y[0], label="$x_1 (Linearyzacja)$")
#plt.plot(ret.t, ret.y[1], label="$x_2 (Linearyzacja)$")
plt.plot(ret.t, ret.y[2], label="$x_3 (Linearyzacja)$")
#plt.plot(ret.t, ret.y[3], label="$x_4 (Linearyzacja)$")
plt.legend()
plt.show()